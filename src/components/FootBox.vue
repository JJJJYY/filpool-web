<template>
    <div class="FootBox">
      <van-tabbar v-model="active" active-color="#E49C3A" inactive-color="#86929D" :safe-area-inset-bottom="true">
        <van-tabbar-item v-for="item in items" :key="item.title" :to="item.router">
          {{item.title}}
          <template #icon="props">
