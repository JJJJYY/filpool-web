<template>
  <div class="uploadBox">
    ...
    <div class="uploadButtonBox">
      <van-button icon="photo" type="primary" style="width: 120px;" color="#f18a2d"
                  :loading="loading"
        loading-text="正在上传" @click="openAcsheel">上传</van-button>
  ...
  export default {
    ...
    methods: {
      onChange(event) {
        ...
        this.$http.post('/setting/upload', formData).then((res) => {
          this.loading = false;
          this.loadImgUrl = res.content;
