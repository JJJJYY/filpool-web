<template>
  <div class="ProductDetail">
    ...
    <div class="container  list page-container">
      ...
      <div class="listBox">
        <van-tabs v-model="active" type="card" color="#ff933c">
          <van-tab title="排队列表">
            <van-list
              v-model="loading"
              :finished="finished"
          ...
          <!-- <van-tab title="详细规则">
            <div class="detail">
              ...
              <div class="content">
                <p>
                  1.BPool矿池“算力加速计划”-期初定于11月10日开始实施，将采用新的独立节点运行，新节点有效算力及挖矿收益并入BPool-期矿池，BPool-期矿池总存储容量不再增加，每名用户将根据其账户有效算力占矿池总有效算力占比来分配收益;
                </p>
                <br />
                <p>
                  2.“算力加速计划”每天限量申请1PiB (1024TiB)
                  ，1TiB有效算力所需质押币按6.4枚FIL计算，最小申请单位为0.001TiB,
                  11月9日12:00开放申请，11月10日开启新节点。BPool矿池用户可申请(充值)
                  FIL数量的.
                ...
                <br />
                <p>
                  4.未参与“算力加速计划”的用户且未将其可用资产提取，则其有效算力将根据BPool-期矿池原有节点“f02770、
                  f02775、
                ...
                <p>
                  ...
                  如用户所购买的服务器托管服务或存储空间租赁服务一年到期后不续约，BPool矿
...
.imageSize {
  height: 165px;
  background-image: url("../../assets/img/smallBanner.png");
