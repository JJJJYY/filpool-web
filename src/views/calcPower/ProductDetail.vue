    ...
    <div class="ProductDetail">
      ...
      <div class="container page-container">
        ...
        <van-popup v-model="show" position="bottom" closeable :safe-area-inset-bottom="true">
          <calc-power-buy-popup v-on:dismiss="show=false" :number="number" :item="detailInfo" v-on:enterOrder="buySubmit"
  ...
  export default {
    ...
    methods: {
      ...
      getDetailById() {
        ...
        this.$http.get('/purchase/access/goodsDetails', {id: rateId}).then((res) => {
