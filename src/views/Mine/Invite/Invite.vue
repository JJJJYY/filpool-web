    ...
    <div class="container page-container">
      <div class="main">
        ...
        <div class="code-container" id="copy-code" @click="copyCode">
          ...
          <img style="height: 18px; margin-left: 8px;" src="../../../assets/img/invite/invitation_code_icon_copy.png"
               alt="">
        </div>
        <button class="btn-gradient invite-btn" @click="toInvite">立即邀请</button>
        <div class="invite-desc">您已邀请人数<span>{{item.inviteCount}}</span> ，购买算力人数<span>{{item.purchaseCount}}</span>，累计获得<span>{{item.usdtReward}}</span>佣金
        </div>
        <div class="hr"></div>
        ...
        <div class="flow-container">
          <div class="flow-item">
            ...
            <div class="flow-item-desc">发送邀请<br>给好友</div>
          </div>
          ...
          <div class="flow-item">
            ...
            <div class="flow-item-desc">好友下载<br>APP</div>
          </div>
          <img class="flow-item-arrow" src="../../../assets/img/invite/invitation_icon_4.png" alt="">
          <div class="flow-item">
            <img class="flow-item-icon" src="../../../assets/img/invite/invitation_icon_3.png" alt="">
            <div class="flow-item-desc">输入您的<br>邀请码</div>
          </div>
        </div>
      </div>
      <div class="reward">
        ...
        <div style="padding: 0 16px;">
          ...
          <div class="reward-progress-container">
            <div class="reward-progress">
              <div class="reward-progress-high gradient" :style="{'width': currentLevelProgress +'%'}"></div>
            </div>
            <img class="reward-progress-dot"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //保存到相册
      saveToGallery () {
        downloadImg(this.item.invitationImage).then(() => {
          Toast('已保存到相册');
        }).catch((err) => {
          Toast(err);
        })
...
<style lang="scss" scoped>
  ...
  .container {
    background: transparent url("../../../assets/img/mine/invitation_bg_1.png") no-repeat;
