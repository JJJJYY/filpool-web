...
const routes = [
  {
    ...
    meta: {showTabBar: true, title: "FILPool.io", backBtnHidden: true, isQuit: true}
  },
  {
    path: '/rate',
    name: 'rate',
    component: () => import(/* webpackChunkName: "count" */'../views/calcPower/CalcPower'),
    meta: {showTabBar: true, title: "云算力", backBtnHidden: true, isQuit: true}
  },
  {
    path: '/ServiceDetail',
    name: 'ServiceDetail',
  ...
  },
  {
    ...
    meta: {showTabBar: true, title: "个人中心", backBtnHidden: true, needLogin: true, isQuit: true}
  }, {
    path: '/classroom',
    name: 'Classroom',
  ...
  },
  {
    ...
    meta: {title: "支付完成", backBtnHidden: true}
  }, {
    path: '/myasset',
    name: 'MyAsset',
    component: () => import(/* webpackChunkName: "mine" */'../views/Mine/MyAsset'),
    meta: {title: "我的资产", needLogin: true}
  }, {
    path: '/selectCurrency',
    name: 'CurrencySelect',
